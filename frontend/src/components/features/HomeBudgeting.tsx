...
const MonthlyDonutChart = React.lazy(() =>
  import('@/components/charts/MonthlyDonutChart').then((m) => ({
    default: m.MonthlyDonutChart,
  }))
);
...
export const HomeBudgeting: React.FC = () => {
  return (
    <div className="mt-6 grid grid-cols-1 gap-4 md:col-span-1 md:gap-8 lg:col-span-9 lg:mt-0 lg:grid-cols-12">
      <Card className="group flex flex-col rounded-[40px] border border-white/60 bg-white/70 p-6 shadow-2xl backdrop-blur-3xl md:col-span-1 md:rounded-[48px] md:p-10 lg:col-span-5">
