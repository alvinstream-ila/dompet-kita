      ...
      <div className="mb-10 flex flex-col items-center justify-between gap-6 md:flex-row">
        ...
        <div className="flex w-full items-center gap-4 md:w-auto">
          <Button
            ...
            className="flex h-14 flex-1 items-center justify-center gap-3 rounded-2xl border-none bg-emerald-50 px-8 text-[10px] font-black tracking-widest text-emerald-600 uppercase shadow-sm transition-all hover:-translate-y-0.5 hover:bg-emerald-100 active:scale-95 md:flex-none"
          >
            <FileSpreadsheet className="h-4 w-4" strokeWidth={3} /> Ekspor Excel
          </Button>
          <Button
            onClick={exportToPDF}
            className="flex h-14 flex-1 items-center justify-center gap-3 rounded-2xl border-none bg-rose-50 px-8 text-[10px] font-black tracking-widest text-rose-600 uppercase shadow-sm transition-all hover:-translate-y-0.5 hover:bg-rose-100 active:scale-95 md:flex-none"
          >
