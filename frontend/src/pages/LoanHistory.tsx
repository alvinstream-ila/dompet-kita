          ...
          <div className="space-y-4 p-6 text-center">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                className="h-12 w-full rounded-xl border-b-4 border-rose-700 bg-rose-500 text-xs font-black text-white uppercase shadow-lg transition-all hover:bg-rose-600 active:translate-y-1 active:border-b-0"
              >
                Hapus Permanen! 🗑️
              </Button>
              <Button
