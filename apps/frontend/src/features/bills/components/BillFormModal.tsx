                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      variant="outline"
                      className={cn(
                        'h-12 w-full justify-start rounded-2xl border-slate-100 bg-slate-50/50 px-3.5 text-left font-bold hover:bg-slate-100',
                        !formData.dueDate && 'text-muted-foreground'
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4 opacity-70" />
                      {formData.dueDate ? (
                        format(new Date(formData.dueDate), 'd MMM yyyy', {
                          locale: id,
                        })
                      ) : (
