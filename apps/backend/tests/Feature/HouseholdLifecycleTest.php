...
class HouseholdLifecycleTest extends TestCase
{
    ...
    public function test_it_prevents_joining_a_household_that_is_already_full()
    {
        ...
        /** @var \App\Models\User|\Illuminate\Contracts\Auth\Authenticatable $invitee */
    ...
    public function test_it_cleans_up_orphaned_households_on_unlink()
    {
        ...
        /** @var \App\Models\User|\Illuminate\Contracts\Auth\Authenticatable $user2 */
    ...
    public function test_it_prevents_currency_change_if_assets_exist()
    {
        ...
        $asset->type = \App\Enums\AssetType::CASH;
        $asset->value = 1000;
        $asset->quantity = 1;
        $asset->save();
