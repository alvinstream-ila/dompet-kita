...
class GetTaxAdviceAction extends BaseAction
{
    ...
    {
        $prompt = "Identitas: Anda adalah 'Sovereign Tax Strategist', pakar perpajakan finansial yang profesional dan akurat untuk Klien.
            ...
            4. If DTP is active, congratulate the client for getting tax incentives from current 2026 regulations (PMK 105/2025).
