...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.maintenance.secure' => 'boolean',
            'app.providers' => 'array',
            ...
            'database.connections.pgsql.prepare' => 'boolean',
            ...
            'filesystems.disks.storj.driver' => 'string',
            'filesystems.disks.storj.key' => 'string',
            'filesystems.disks.storj.secret' => 'string',
            'filesystems.disks.storj.region' => 'string',
            'filesystems.disks.storj.bucket' => 'string',
            'filesystems.disks.storj.endpoint' => 'string',
            'filesystems.disks.storj.use_path_style_endpoint' => 'boolean',
            'filesystems.links.C:\Programing alvin\dompet-kita\apps\backend\public\storage' => 'string',
            ...
            'mail.mailers.google.transport' => 'string',
            'mail.mailers.google.client_id' => 'string',
            'mail.mailers.google.client_secret' => 'string',
            'mail.mailers.google.refresh_token' => 'string',
            ...
            'services.ai.primary' => 'string',
            'services.ai.groq.key' => 'string',
            'services.ai.groq.model' => 'string',
            'services.ai.openrouter.key' => 'string',
            'services.ai.openrouter.model_text' => 'string',
            'services.ai.openrouter.model_vision' => 'string',
...
'app.maintenance.driver','app.maintenance.secure','app.providers','app.aliases.App','app.aliases.Arr',
...
'auth.passwords.users.throttle','auth.password_timeout','auth.verification.expire','cache.default','cache.stores.array.driver',
...
'database.connections.pgsql.sslmode','database.connections.pgsql.prepare','database.connections.sqlsrv.driver','database.connections.sqlsrv.url','database.connections.sqlsrv.host',
...
'filesystems.disks.storj.driver','filesystems.disks.storj.key','filesystems.disks.storj.secret','filesystems.disks.storj.region','filesystems.disks.storj.bucket',
'filesystems.disks.storj.endpoint','filesystems.disks.storj.use_path_style_endpoint','filesystems.links.C:\\Programing alvin\\dompet-kita\\apps\\backend\\public\\storage','honeypot.enabled','honeypot.name_field_name',
'honeypot.randomize_name_field_name','honeypot.valid_from_timestamp','honeypot.valid_from_field_name','honeypot.amount_of_seconds','honeypot.respond_to_spam_with',
'honeypot.honeypot_fields_required_for_all_forms','honeypot.spam_protection','honeypot.with_csp','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'l5-swagger.defaults.ui.display.filter','l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','logging.default',
...
'logging.channels.stack.level','logging.channels.single.driver','logging.channels.single.path','logging.channels.single.level','logging.channels.single.replace_placeholders',
...
'mail.mailers.smtp.username','mail.mailers.smtp.password','mail.mailers.smtp.encryption','mail.mailers.smtp.timeout','mail.mailers.smtp.local_domain',
...
'mail.mailers.failover.retry_after','mail.mailers.roundrobin.transport','mail.mailers.roundrobin.mailers','mail.mailers.roundrobin.retry_after','mail.mailers.google.transport',
'mail.mailers.google.client_id','mail.mailers.google.client_secret','mail.mailers.google.refresh_token','mail.from.address','mail.from.name',
...
'sentry.org_id','sentry.sample_rate','sentry.traces_sample_rate','sentry.profiles_sample_rate','sentry.strict_trace_continuation',
'sentry.enable_logs','sentry.log_flush_threshold','sentry.logs_channel_level','sentry.send_default_pii','sentry.ignore_transactions',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.gemini.key','services.ai.primary','services.ai.groq.key',
'services.ai.groq.model','services.ai.openrouter.key','services.ai.openrouter.model_text','services.ai.openrouter.model_vision','services.google.client_id',
...
'session.partitioned','activitylog.enabled','activitylog.clean_after_days','activitylog.default_log_name','activitylog.default_auth_driver',
'activitylog.include_soft_deleted_subjects','activitylog.activity_model','activitylog.default_except_attributes','activitylog.buffer.enabled','activitylog.actions.log_activity',
'activitylog.actions.clean_log','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','sudo',);
        registerArgumentsSet('routes', 
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','password.reset','verification.verify','verification.send','transactions.index','transactions.store',
'transactions.show','transactions.update','transactions.destroy','assets.index','assets.store','assets.show',
'assets.update','assets.destroy','loans.index','loans.store','loans.show',
'loans.update','loans.destroy','goals.index',
'goals.store','goals.show','goals.update','goals.destroy',
'scheduled-transactions.index','scheduled-transactions.store','scheduled-transactions.show','scheduled-transactions.update','scheduled-transactions.destroy','holidays.index',
'holidays.store','holidays.show','holidays.update','holidays.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.reset-password','emails.verify-email','welcome','honeypot::honeypotFormFields','l5-swagger::index',
...
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Programing alvin.dompet-kita.apps.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle','pagination.previous',
...
'validation.uuid','validation.custom.attribute-name.rule-name','api.verification_invalid','api.verification_success','api.already_verified',
'api.notification_sent','validation.password','validation.attributes.email','validation.attributes.password','validation.attributes.amount',
'validation.attributes.name','validation.attributes.debtor',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'FRONTEND_URL','APP_TIMEZONE','APP_LOCALE','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','DATABASE_URL',
'FILESYSTEM_DISK','STORJ_ACCESS_KEY','STORJ_SECRET_KEY','STORJ_BUCKET','STORJ_ENDPOINT',
'SESSION_DRIVER','CACHE_STORE','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_SECURE_COOKIE','SESSION_SAME_SITE','TRUST_PROXIES','TRUSTED_PROXIES','PROXIES',
'CORS_ALLOWED_ORIGINS','SANCTUM_STATEFUL_DOMAINS','AI_PRIMARY_PROVIDER','GROQ_API_KEY','GROQ_MODEL',
'OPENROUTER_API_KEY','OPENROUTER_MODEL','OPENROUTER_MODEL_VISION','GEMINI_API_KEY','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','GOOGLE_MAIL_CLIENT_ID','GOOGLE_MAIL_CLIENT_SECRET','GOOGLE_MAIL_REFRESH_TOKEN',
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','FACEBOOK_CLIENT_ID','FACEBOOK_CLIENT_SECRET',
'FACEBOOK_REDIRECT_URL','PORT','NIXPACKS_PHP_VERSION','LOG_CHANNEL','RAILWAY_API_KEY',
'SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE','LANGSMITH_API_KEY','LANGSMITH_PROJECT',);
