...
function vsCodeGetTranslationsFromFile(SplFileInfo $file, $path, $namespace)
{
    ...
    return [
        'k' => $baseKey,
        'la' => $lang,
        'vs' => collect(Arr::dot($translations))
            ->map(
...
function vscodeCollectTranslations(string $path, ?string $namespace = null)
{
    ...
    return collect(File::allFiles($realPath))
