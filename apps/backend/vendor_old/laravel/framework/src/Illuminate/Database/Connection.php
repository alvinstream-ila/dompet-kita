...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var DatabaseTransactionsManager|null
     */
     ...
     *
     * @var array{has_run: bool, handler: (callable(Connection, class-string<QueryExecuted>): mixed)}[]
     */
     ...
     *
     * @var (Closure(string, array, Connection): mixed)[]
     */
     ...
     *
     * @return Schema\Grammars\Grammar|null
     */
     ...
     *
     * @param  Closure|QueryBuilder|\Illuminate\Contracts\Database\Query\Expression|\UnitEnum|string  $table
     ...
     * @param  (callable(Connection, QueryExecuted): mixed)  $handler
     * @return void
     */
     ...
     *
     * @param  Closure(QueryExecuted)  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(Connection): mixed)  $reconnector
     * @return $this
     */
