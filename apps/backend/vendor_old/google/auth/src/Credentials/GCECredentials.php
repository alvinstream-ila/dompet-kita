 ...
 */
class GCECredentials extends CredentialsLoader implements GetQuotaProjectInterface, ProjectIdProviderInterface, SignBlobInterface
{
    use IamSignerTrait;
    ...
    private static function detectResidencyLinux(string $productNameFile): bool
    {
        if (file_exists($productNameFile)) {
            ...
            return strpos($productName, self::PRODUCT_NAME) === 0;
        }
