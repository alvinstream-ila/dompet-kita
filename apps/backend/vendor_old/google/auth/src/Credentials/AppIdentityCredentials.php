 ...
 * ```
 */
class AppIdentityCredentials extends CredentialsLoader implements ProjectIdProviderInterface, SignBlobInterface
{
    /**
    ...
    public static function onAppEngine()
    {
        $appEngineProduction = isset($_SERVER['SERVER_SOFTWARE']) &&
            strpos($_SERVER['SERVER_SOFTWARE'], 'Google App Engine') === 0;
