 ...
 */
class FetchAuthTokenCache implements FetchAuthTokenInterface, GetQuotaProjectInterface, GetUniverseDomainInterface, ProjectIdProviderInterface, SignBlobInterface, UpdateMetadataInterface
{
    use CacheTrait;
