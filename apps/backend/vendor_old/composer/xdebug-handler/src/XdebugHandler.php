...
class XdebugHandler
{
    ...
    public function check(): void
    {
        ...
        if ($envArgs[0] === self::RESTART_ID && count($envArgs) === 5) {
    ...
    {
        if (getenv($this->envOriginalInis) === false) {
