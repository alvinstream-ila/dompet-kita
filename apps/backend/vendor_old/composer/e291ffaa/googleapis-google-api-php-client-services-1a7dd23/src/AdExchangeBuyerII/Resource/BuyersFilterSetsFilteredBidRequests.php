 ...
 *   $filteredBidRequests = $adexchangebuyer2Service->buyers_filterSets_filteredBidRequests;
 *  </code>
 */
class BuyersFilterSetsFilteredBidRequests extends \Google\Service\Resource
{
    /**
     ...
     * (filteredBidRequests.listBuyersFilterSetsFilteredBidRequests)
     *
     ...
     * @throws Exception
     */
    public function listBuyersFilterSetsFilteredBidRequests($filterSetName, $optParams = [])
    {
...
class_alias(BuyersFilterSetsFilteredBidRequests::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsFilteredBidRequests');
