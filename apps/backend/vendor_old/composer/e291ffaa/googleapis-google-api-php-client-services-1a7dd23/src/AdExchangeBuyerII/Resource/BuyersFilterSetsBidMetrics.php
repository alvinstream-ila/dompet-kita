 ...
 *   $bidMetrics = $adexchangebuyer2Service->buyers_filterSets_bidMetrics;
 *  </code>
 */
class BuyersFilterSetsBidMetrics extends \Google\Service\Resource
{
    /**
     * Lists all metrics that are measured in terms of number of bids.
     * (bidMetrics.listBuyersFilterSetsBidMetrics)
     *
     ...
     * @throws Exception
     */
    public function listBuyersFilterSetsBidMetrics($filterSetName, $optParams = [])
    {
        $params = ['filterSetName' => $filterSetName];
        $params = array_merge($params, $optParams);

        return $this->call('list', [$params], ListBidMetricsResponse::class);
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(BuyersFilterSetsBidMetrics::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsBidMetrics');
