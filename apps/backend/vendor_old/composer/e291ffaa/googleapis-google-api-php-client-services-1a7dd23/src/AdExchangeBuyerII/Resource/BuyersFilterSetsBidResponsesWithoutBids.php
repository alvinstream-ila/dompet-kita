 ...
 *  </code>
 */
class BuyersFilterSetsBidResponsesWithoutBids extends \Google\Service\Resource
{
    /**
     ...
     * @throws Exception
     */
    public function listBuyersFilterSetsBidResponsesWithoutBids($filterSetName, $optParams = [])
    {
...
class_alias(BuyersFilterSetsBidResponsesWithoutBids::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsBidResponsesWithoutBids');
