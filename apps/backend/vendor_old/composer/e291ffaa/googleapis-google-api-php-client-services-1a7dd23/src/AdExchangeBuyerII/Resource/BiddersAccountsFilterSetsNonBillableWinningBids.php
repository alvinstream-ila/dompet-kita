...
class_alias(BiddersAccountsFilterSetsNonBillableWinningBids::class, 'Google_Service_AdExchangeBuyerII_Resource_BiddersAccountsFilterSetsNonBillableWinningBids');
