 ...
 *   $creatives = $adexchangebuyer2Service->bidders_filterSets_filteredBids_creatives;
 *  </code>
 */
class BiddersFilterSetsFilteredBidsCreatives extends \Google\Service\Resource
{
    /**
     ...
     * @throws Exception
     */
    public function listBiddersFilterSetsFilteredBidsCreatives($filterSetName, $creativeStatusId, $optParams = [])
    {
...
class_alias(BiddersFilterSetsFilteredBidsCreatives::class, 'Google_Service_AdExchangeBuyerII_Resource_BiddersFilterSetsFilteredBidsCreatives');
