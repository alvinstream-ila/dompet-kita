...
class_alias(BiddersAccountsFilterSetsBidResponsesWithoutBids::class, 'Google_Service_AdExchangeBuyerII_Resource_BiddersAccountsFilterSetsBidResponsesWithoutBids');
