 ...
 *  </code>
 */
class BuyersFilterSetsFilteredBidsDetails extends \Google\Service\Resource
{
    /**
     ...
     * @throws Exception
     */
    public function listBuyersFilterSetsFilteredBidsDetails($filterSetName, $creativeStatusId, $optParams = [])
    {
...
class_alias(BuyersFilterSetsFilteredBidsDetails::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsFilteredBidsDetails');
