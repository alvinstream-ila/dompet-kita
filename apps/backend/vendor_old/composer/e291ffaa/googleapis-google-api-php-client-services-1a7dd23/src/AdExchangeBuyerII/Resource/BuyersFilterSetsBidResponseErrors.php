 ...
 *  </code>
 */
class BuyersFilterSetsBidResponseErrors extends \Google\Service\Resource
{
    /**
...
class_alias(BuyersFilterSetsBidResponseErrors::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsBidResponseErrors');
