 ...
 *   $impressionMetrics = $adexchangebuyer2Service->buyers_filterSets_impressionMetrics;
 *  </code>
 */
class BuyersFilterSetsImpressionMetrics extends \Google\Service\Resource
{
    /**
     * Lists all metrics that are measured in terms of number of impressions.
     * (impressionMetrics.listBuyersFilterSetsImpressionMetrics)
     *
     ...
     * @throws Exception
     */
    public function listBuyersFilterSetsImpressionMetrics($filterSetName, $optParams = [])
    {
...
class_alias(BuyersFilterSetsImpressionMetrics::class, 'Google_Service_AdExchangeBuyerII_Resource_BuyersFilterSetsImpressionMetrics');
