...
class GoogleCloudApihubV1PluginInstanceActionSource extends Model
{
    /**
...
class_alias(GoogleCloudApihubV1PluginInstanceActionSource::class, 'Google_Service_APIhub_GoogleCloudApihubV1PluginInstanceActionSource');
