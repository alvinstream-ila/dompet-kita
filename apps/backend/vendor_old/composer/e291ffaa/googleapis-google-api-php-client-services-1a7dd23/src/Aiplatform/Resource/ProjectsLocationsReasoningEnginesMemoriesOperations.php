 ...
 *   $operations = $aiplatformService->projects_locations_reasoningEngines_memories_operations;
 *  </code>
 */
class ProjectsLocationsReasoningEnginesMemoriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsReasoningEnginesMemoriesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsReasoningEnginesMemoriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsReasoningEnginesMemoriesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsReasoningEnginesMemoriesOperations');
