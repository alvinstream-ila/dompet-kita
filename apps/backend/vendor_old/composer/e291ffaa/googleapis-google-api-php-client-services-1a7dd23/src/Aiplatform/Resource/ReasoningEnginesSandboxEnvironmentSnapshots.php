 ...
 *   $sandboxEnvironmentSnapshots = $aiplatformService->reasoningEngines_sandboxEnvironmentSnapshots;
 *  </code>
 */
class ReasoningEnginesSandboxEnvironmentSnapshots extends \Google\Service\Resource
{
    /**
     ...
     * (sandboxEnvironmentSnapshots.listReasoningEnginesSandboxEnvironmentSnapshots)
     *
     ...
     * @throws Exception
     */
    public function listReasoningEnginesSandboxEnvironmentSnapshots($parent, $optParams = [])
    {
...
class_alias(ReasoningEnginesSandboxEnvironmentSnapshots::class, 'Google_Service_Aiplatform_Resource_ReasoningEnginesSandboxEnvironmentSnapshots');
