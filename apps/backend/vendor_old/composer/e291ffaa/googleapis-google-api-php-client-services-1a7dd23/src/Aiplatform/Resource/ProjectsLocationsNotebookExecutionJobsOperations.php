 ...
 *   $operations = $aiplatformService->projects_locations_notebookExecutionJobs_operations;
 *  </code>
 */
class ProjectsLocationsNotebookExecutionJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsNotebookExecutionJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsNotebookExecutionJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsNotebookExecutionJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsNotebookExecutionJobsOperations');
