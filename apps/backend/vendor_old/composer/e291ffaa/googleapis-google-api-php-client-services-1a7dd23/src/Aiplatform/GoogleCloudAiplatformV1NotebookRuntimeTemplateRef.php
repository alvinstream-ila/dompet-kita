...
class GoogleCloudAiplatformV1NotebookRuntimeTemplateRef extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1NotebookRuntimeTemplateRef::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1NotebookRuntimeTemplateRef');
