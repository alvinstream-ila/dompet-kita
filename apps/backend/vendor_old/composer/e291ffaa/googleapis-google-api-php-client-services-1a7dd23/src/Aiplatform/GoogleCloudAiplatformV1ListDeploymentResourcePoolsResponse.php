...
class GoogleCloudAiplatformV1ListDeploymentResourcePoolsResponse extends Collection
{
    ...
    {
        $this->deploymentResourcePools = $deploymentResourcePools;
    }
...
class_alias(GoogleCloudAiplatformV1ListDeploymentResourcePoolsResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ListDeploymentResourcePoolsResponse');
