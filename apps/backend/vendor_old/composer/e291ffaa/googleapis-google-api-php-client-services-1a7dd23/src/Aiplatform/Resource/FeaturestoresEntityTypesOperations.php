 ...
 *   $operations = $aiplatformService->featurestores_entityTypes_operations;
 *  </code>
 */
class FeaturestoresEntityTypesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listFeaturestoresEntityTypesOperations)
     *
     ...
     * @throws Exception
     */
    public function listFeaturestoresEntityTypesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(FeaturestoresEntityTypesOperations::class, 'Google_Service_Aiplatform_Resource_FeaturestoresEntityTypesOperations');
