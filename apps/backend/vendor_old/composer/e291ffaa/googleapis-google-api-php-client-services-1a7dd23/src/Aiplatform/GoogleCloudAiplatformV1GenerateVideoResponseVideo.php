...
class GoogleCloudAiplatformV1GenerateVideoResponseVideo extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1GenerateVideoResponseVideo::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1GenerateVideoResponseVideo');
