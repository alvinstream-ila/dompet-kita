 ...
 *   $operations = $aiplatformService->dataLabelingJobs_operations;
 *  </code>
 */
class DataLabelingJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDataLabelingJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDataLabelingJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DataLabelingJobsOperations::class, 'Google_Service_Aiplatform_Resource_DataLabelingJobsOperations');
