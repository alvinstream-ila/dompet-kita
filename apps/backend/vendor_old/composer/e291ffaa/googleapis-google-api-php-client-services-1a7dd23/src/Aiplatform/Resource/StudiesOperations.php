 ...
 *   $operations = $aiplatformService->studies_operations;
 *  </code>
 */
class StudiesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listStudiesOperations)
     *
     ...
     * @throws Exception
     */
    public function listStudiesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(StudiesOperations::class, 'Google_Service_Aiplatform_Resource_StudiesOperations');
