 ...
 *   $operations = $aiplatformService->notebookExecutionJobs_operations;
 *  </code>
 */
class NotebookExecutionJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listNotebookExecutionJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listNotebookExecutionJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(NotebookExecutionJobsOperations::class, 'Google_Service_Aiplatform_Resource_NotebookExecutionJobsOperations');
