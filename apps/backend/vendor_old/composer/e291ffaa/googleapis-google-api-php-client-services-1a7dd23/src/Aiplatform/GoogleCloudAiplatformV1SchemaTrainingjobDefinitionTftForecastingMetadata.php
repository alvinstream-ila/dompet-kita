...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingMetadata extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingMetadata');
