 ...
 *   $operations = $aiplatformService->tensorboards_operations;
 *  </code>
 */
class TensorboardsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listTensorboardsOperations)
     *
     ...
     * @throws Exception
     */
    public function listTensorboardsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(TensorboardsOperations::class, 'Google_Service_Aiplatform_Resource_TensorboardsOperations');
