 ...
 *   $operations = $aiplatformService->datasets_dataItems_annotations_operations;
 *  </code>
 */
class DatasetsDataItemsAnnotationsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDatasetsDataItemsAnnotationsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDatasetsDataItemsAnnotationsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DatasetsDataItemsAnnotationsOperations::class, 'Google_Service_Aiplatform_Resource_DatasetsDataItemsAnnotationsOperations');
