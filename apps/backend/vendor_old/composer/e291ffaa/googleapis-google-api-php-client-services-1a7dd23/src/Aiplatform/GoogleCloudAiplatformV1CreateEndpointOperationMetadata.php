...
class GoogleCloudAiplatformV1CreateEndpointOperationMetadata extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1CreateEndpointOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateEndpointOperationMetadata');
