...
class GoogleCloudAiplatformV1EnterpriseWebSearch extends Collection
{
    /**
...
class_alias(GoogleCloudAiplatformV1EnterpriseWebSearch::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1EnterpriseWebSearch');
