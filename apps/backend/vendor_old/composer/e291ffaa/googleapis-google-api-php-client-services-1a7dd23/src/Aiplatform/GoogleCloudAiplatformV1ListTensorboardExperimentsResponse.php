...
class GoogleCloudAiplatformV1ListTensorboardExperimentsResponse extends Collection
{
    ...
    {
        return $this->tensorboardExperiments;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ListTensorboardExperimentsResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ListTensorboardExperimentsResponse');
