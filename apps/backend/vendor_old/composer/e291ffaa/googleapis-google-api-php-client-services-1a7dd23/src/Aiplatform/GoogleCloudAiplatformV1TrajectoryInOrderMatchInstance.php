...
class GoogleCloudAiplatformV1TrajectoryInOrderMatchInstance extends Model
{
...
class_alias(GoogleCloudAiplatformV1TrajectoryInOrderMatchInstance::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectoryInOrderMatchInstance');
