...
class GoogleCloudAiplatformV1EvaluationResults extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1EvaluationResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1EvaluationResults');
