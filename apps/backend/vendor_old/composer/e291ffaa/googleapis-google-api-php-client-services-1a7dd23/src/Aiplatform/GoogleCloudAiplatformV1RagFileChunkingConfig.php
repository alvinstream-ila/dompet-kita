...
class GoogleCloudAiplatformV1RagFileChunkingConfig extends Model
{
    ...
    {
        return $this->fixedLengthChunking;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1RagFileChunkingConfig::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1RagFileChunkingConfig');
