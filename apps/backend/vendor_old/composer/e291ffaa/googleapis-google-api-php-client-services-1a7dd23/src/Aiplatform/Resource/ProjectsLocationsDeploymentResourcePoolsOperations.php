 ...
 *   $operations = $aiplatformService->projects_locations_deploymentResourcePools_operations;
 *  </code>
 */
class ProjectsLocationsDeploymentResourcePoolsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDeploymentResourcePoolsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDeploymentResourcePoolsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDeploymentResourcePoolsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDeploymentResourcePoolsOperations');
