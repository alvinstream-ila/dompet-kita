 ...
 *   $operations = $aiplatformService->projects_locations_featurestores_operations;
 *  </code>
 */
class ProjectsLocationsFeaturestoresOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsFeaturestoresOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsFeaturestoresOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsFeaturestoresOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsFeaturestoresOperations');
