 ...
 *   $operations = $aiplatformService->studies_trials_operations;
 *  </code>
 */
class StudiesTrialsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listStudiesTrialsOperations)
     *
     ...
     * @throws Exception
     */
    public function listStudiesTrialsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(StudiesTrialsOperations::class, 'Google_Service_Aiplatform_Resource_StudiesTrialsOperations');
