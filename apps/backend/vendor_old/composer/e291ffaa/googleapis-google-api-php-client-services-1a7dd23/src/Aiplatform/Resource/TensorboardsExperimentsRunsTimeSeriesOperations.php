 ...
 *   $operations = $aiplatformService->tensorboards_experiments_runs_timeSeries_operations;
 *  </code>
 */
class TensorboardsExperimentsRunsTimeSeriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listTensorboardsExperimentsRunsTimeSeriesOperations)
     *
     ...
     * @throws Exception
     */
    public function listTensorboardsExperimentsRunsTimeSeriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(TensorboardsExperimentsRunsTimeSeriesOperations::class, 'Google_Service_Aiplatform_Resource_TensorboardsExperimentsRunsTimeSeriesOperations');
