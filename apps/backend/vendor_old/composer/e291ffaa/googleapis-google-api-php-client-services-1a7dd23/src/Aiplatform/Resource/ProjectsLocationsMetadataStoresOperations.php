 ...
 *   $operations = $aiplatformService->projects_locations_metadataStores_operations;
 *  </code>
 */
class ProjectsLocationsMetadataStoresOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsMetadataStoresOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsMetadataStoresOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMetadataStoresOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMetadataStoresOperations');
