...
class GoogleCloudAiplatformV1ToolParameterKVMatchResults extends Collection
{
    ...
    {
        return $this->toolParameterKvMatchMetricValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ToolParameterKVMatchResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ToolParameterKVMatchResults');
