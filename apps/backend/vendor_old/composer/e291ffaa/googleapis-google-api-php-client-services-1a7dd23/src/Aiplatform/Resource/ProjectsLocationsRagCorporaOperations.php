 ...
 *   $operations = $aiplatformService->projects_locations_ragCorpora_operations;
 *  </code>
 */
class ProjectsLocationsRagCorporaOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsRagCorporaOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsRagCorporaOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsRagCorporaOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsRagCorporaOperations');
