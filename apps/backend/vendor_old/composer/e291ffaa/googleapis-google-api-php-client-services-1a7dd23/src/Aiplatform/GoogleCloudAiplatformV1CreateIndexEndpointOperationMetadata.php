...
class GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata extends Model
{
...
class_alias(GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata');
