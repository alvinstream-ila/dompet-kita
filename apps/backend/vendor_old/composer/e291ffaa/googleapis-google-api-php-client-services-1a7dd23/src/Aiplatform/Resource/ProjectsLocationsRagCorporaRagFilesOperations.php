 ...
 *   $operations = $aiplatformService->projects_locations_ragCorpora_ragFiles_operations;
 *  </code>
 */
class ProjectsLocationsRagCorporaRagFilesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsRagCorporaRagFilesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsRagCorporaRagFilesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsRagCorporaRagFilesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsRagCorporaRagFilesOperations');
