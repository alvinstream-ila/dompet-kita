...
class GoogleCloudAiplatformV1ExactMatchResults extends Collection
{
    ...
    {
        return $this->exactMatchMetricValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ExactMatchResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ExactMatchResults');
