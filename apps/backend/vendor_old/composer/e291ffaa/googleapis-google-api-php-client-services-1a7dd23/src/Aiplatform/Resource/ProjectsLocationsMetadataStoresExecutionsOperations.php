 ...
 *   $operations = $aiplatformService->projects_locations_metadataStores_executions_operations;
 *  </code>
 */
class ProjectsLocationsMetadataStoresExecutionsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsMetadataStoresExecutionsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsMetadataStoresExecutionsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMetadataStoresExecutionsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMetadataStoresExecutionsOperations');
