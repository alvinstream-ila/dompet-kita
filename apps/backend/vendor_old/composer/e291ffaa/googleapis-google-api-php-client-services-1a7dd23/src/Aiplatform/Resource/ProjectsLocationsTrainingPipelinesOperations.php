 ...
 *   $operations = $aiplatformService->projects_locations_trainingPipelines_operations;
 *  </code>
 */
class ProjectsLocationsTrainingPipelinesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsTrainingPipelinesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsTrainingPipelinesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTrainingPipelinesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTrainingPipelinesOperations');
