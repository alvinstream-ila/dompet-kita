 ...
 *  </code>
 */
class ProjectsLocationsTensorboardsExperimentsRunsTimeSeriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * @throws Exception
     */
    public function listProjectsLocationsTensorboardsExperimentsRunsTimeSeriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTensorboardsExperimentsRunsTimeSeriesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTensorboardsExperimentsRunsTimeSeriesOperations');
