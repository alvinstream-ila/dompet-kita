 ...
 *   $operations = $aiplatformService->deploymentResourcePools_operations;
 *  </code>
 */
class DeploymentResourcePoolsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDeploymentResourcePoolsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDeploymentResourcePoolsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DeploymentResourcePoolsOperations::class, 'Google_Service_Aiplatform_Resource_DeploymentResourcePoolsOperations');
