 ...
 *   $operations = $aiplatformService->projects_locations_featureGroups_operations;
 *  </code>
 */
class ProjectsLocationsFeatureGroupsOperations extends \Google\Service\Resource
{
    /**
...
class_alias(ProjectsLocationsFeatureGroupsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsFeatureGroupsOperations');
