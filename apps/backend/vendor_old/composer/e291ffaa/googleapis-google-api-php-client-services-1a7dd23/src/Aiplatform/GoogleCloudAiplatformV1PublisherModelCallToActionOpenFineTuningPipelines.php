...
class GoogleCloudAiplatformV1PublisherModelCallToActionOpenFineTuningPipelines extends Collection
{
    ...
    {
        $this->fineTuningPipelines = $fineTuningPipelines;
    }
    ...
    {
        return $this->fineTuningPipelines;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1PublisherModelCallToActionOpenFineTuningPipelines::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1PublisherModelCallToActionOpenFineTuningPipelines');
