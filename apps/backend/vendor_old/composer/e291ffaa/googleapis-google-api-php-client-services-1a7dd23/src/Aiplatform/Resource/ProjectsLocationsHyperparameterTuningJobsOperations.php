 ...
 *   $operations = $aiplatformService->projects_locations_hyperparameterTuningJobs_operations;
 *  </code>
 */
class ProjectsLocationsHyperparameterTuningJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsHyperparameterTuningJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsHyperparameterTuningJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsHyperparameterTuningJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsHyperparameterTuningJobsOperations');
