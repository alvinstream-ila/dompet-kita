 ...
 *   $operations = $aiplatformService->notebookRuntimeTemplates_operations;
 *  </code>
 */
class NotebookRuntimeTemplatesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listNotebookRuntimeTemplatesOperations)
     *
     ...
     * @throws Exception
     */
    public function listNotebookRuntimeTemplatesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(NotebookRuntimeTemplatesOperations::class, 'Google_Service_Aiplatform_Resource_NotebookRuntimeTemplatesOperations');
