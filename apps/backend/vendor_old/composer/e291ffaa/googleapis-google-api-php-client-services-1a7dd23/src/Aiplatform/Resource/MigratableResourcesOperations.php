 ...
 *   $operations = $aiplatformService->migratableResources_operations;
 *  </code>
 */
class MigratableResourcesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listMigratableResourcesOperations)
     *
     ...
     * @throws Exception
     */
    public function listMigratableResourcesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(MigratableResourcesOperations::class, 'Google_Service_Aiplatform_Resource_MigratableResourcesOperations');
