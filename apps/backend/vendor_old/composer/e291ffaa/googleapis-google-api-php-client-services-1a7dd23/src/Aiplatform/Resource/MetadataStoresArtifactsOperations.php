 ...
 *   $operations = $aiplatformService->metadataStores_artifacts_operations;
 *  </code>
 */
class MetadataStoresArtifactsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listMetadataStoresArtifactsOperations)
     *
     ...
     * @throws Exception
     */
    public function listMetadataStoresArtifactsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(MetadataStoresArtifactsOperations::class, 'Google_Service_Aiplatform_Resource_MetadataStoresArtifactsOperations');
