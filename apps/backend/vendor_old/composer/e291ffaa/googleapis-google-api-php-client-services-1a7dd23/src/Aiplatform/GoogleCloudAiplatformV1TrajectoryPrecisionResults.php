...
class GoogleCloudAiplatformV1TrajectoryPrecisionResults extends Collection
{
    ...
    {
        return $this->trajectoryPrecisionMetricValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1TrajectoryPrecisionResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectoryPrecisionResults');
