 ...
 *   $operations = $aiplatformService->featureOnlineStores_operations;
 *  </code>
 */
class FeatureOnlineStoresOperations extends \Google\Service\Resource
{
    /**
...
class_alias(FeatureOnlineStoresOperations::class, 'Google_Service_Aiplatform_Resource_FeatureOnlineStoresOperations');
