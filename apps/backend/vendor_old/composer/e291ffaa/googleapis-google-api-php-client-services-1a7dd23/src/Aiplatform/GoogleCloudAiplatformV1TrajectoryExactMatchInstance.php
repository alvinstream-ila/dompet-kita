...
class GoogleCloudAiplatformV1TrajectoryExactMatchInstance extends Model
{
...
class_alias(GoogleCloudAiplatformV1TrajectoryExactMatchInstance::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectoryExactMatchInstance');
