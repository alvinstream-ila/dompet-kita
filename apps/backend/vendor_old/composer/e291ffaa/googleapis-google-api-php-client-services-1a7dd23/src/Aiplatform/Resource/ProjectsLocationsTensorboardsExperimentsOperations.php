 ...
 *   $operations = $aiplatformService->projects_locations_tensorboards_experiments_operations;
 *  </code>
 */
class ProjectsLocationsTensorboardsExperimentsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsTensorboardsExperimentsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsTensorboardsExperimentsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTensorboardsExperimentsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTensorboardsExperimentsOperations');
