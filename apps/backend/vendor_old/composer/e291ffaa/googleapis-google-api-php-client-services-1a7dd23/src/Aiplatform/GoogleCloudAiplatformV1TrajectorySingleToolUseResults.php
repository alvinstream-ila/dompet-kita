...
class GoogleCloudAiplatformV1TrajectorySingleToolUseResults extends Collection
{
    ...
    {
        $this->trajectorySingleToolUseMetricValues = $trajectorySingleToolUseMetricValues;
    }
    ...
    {
        return $this->trajectorySingleToolUseMetricValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1TrajectorySingleToolUseResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectorySingleToolUseResults');
