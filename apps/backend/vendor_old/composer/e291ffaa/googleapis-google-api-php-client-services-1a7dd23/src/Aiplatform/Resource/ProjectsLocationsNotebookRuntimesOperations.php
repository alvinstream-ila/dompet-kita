 ...
 *   $operations = $aiplatformService->projects_locations_notebookRuntimes_operations;
 *  </code>
 */
class ProjectsLocationsNotebookRuntimesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsNotebookRuntimesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsNotebookRuntimesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsNotebookRuntimesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsNotebookRuntimesOperations');
