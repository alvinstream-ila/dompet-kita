 ...
 *   $operations = $aiplatformService->reasoningEngines_memories_operations;
 *  </code>
 */
class ReasoningEnginesMemoriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listReasoningEnginesMemoriesOperations)
     *
     ...
     * @throws Exception
     */
    public function listReasoningEnginesMemoriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ReasoningEnginesMemoriesOperations::class, 'Google_Service_Aiplatform_Resource_ReasoningEnginesMemoriesOperations');
