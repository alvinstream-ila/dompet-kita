 ...
 *   $operations = $aiplatformService->specialistPools_operations;
 *  </code>
 */
class SpecialistPoolsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listSpecialistPoolsOperations)
     *
     ...
     * @throws Exception
     */
    public function listSpecialistPoolsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(SpecialistPoolsOperations::class, 'Google_Service_Aiplatform_Resource_SpecialistPoolsOperations');
