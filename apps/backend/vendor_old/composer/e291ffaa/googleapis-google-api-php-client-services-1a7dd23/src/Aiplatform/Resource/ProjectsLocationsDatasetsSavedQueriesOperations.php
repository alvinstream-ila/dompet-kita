 ...
 *   $operations = $aiplatformService->projects_locations_datasets_savedQueries_operations;
 *  </code>
 */
class ProjectsLocationsDatasetsSavedQueriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDatasetsSavedQueriesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDatasetsSavedQueriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDatasetsSavedQueriesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDatasetsSavedQueriesOperations');
