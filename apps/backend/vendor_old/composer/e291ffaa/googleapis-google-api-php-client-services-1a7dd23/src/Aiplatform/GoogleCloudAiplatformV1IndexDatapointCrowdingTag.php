...
class GoogleCloudAiplatformV1IndexDatapointCrowdingTag extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1IndexDatapointCrowdingTag::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1IndexDatapointCrowdingTag');
