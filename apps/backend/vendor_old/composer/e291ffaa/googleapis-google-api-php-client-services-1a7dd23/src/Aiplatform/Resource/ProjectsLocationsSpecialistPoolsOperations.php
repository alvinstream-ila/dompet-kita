 ...
 *   $operations = $aiplatformService->projects_locations_specialistPools_operations;
 *  </code>
 */
class ProjectsLocationsSpecialistPoolsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsSpecialistPoolsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsSpecialistPoolsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsSpecialistPoolsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsSpecialistPoolsOperations');
