...
class GoogleCloudAiplatformV1CreateMetadataStoreOperationMetadata extends Model
{
...
class_alias(GoogleCloudAiplatformV1CreateMetadataStoreOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateMetadataStoreOperationMetadata');
