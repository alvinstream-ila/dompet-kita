...
class GoogleCloudAiplatformV1StratifiedSplit extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1StratifiedSplit::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1StratifiedSplit');
