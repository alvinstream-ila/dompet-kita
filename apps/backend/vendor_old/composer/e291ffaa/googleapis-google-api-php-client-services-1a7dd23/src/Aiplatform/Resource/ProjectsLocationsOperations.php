 ...
 *   $operations = $aiplatformService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsOperations');
