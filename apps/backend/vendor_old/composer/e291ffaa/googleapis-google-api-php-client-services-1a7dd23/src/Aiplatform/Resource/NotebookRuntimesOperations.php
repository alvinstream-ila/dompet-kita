 ...
 *   $operations = $aiplatformService->notebookRuntimes_operations;
 *  </code>
 */
class NotebookRuntimesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listNotebookRuntimesOperations)
     *
     ...
     * @throws Exception
     */
    public function listNotebookRuntimesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(NotebookRuntimesOperations::class, 'Google_Service_Aiplatform_Resource_NotebookRuntimesOperations');
