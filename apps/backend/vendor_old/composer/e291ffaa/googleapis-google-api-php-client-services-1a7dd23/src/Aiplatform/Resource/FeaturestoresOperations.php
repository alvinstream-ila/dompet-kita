 ...
 *   $operations = $aiplatformService->featurestores_operations;
 *  </code>
 */
class FeaturestoresOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listFeaturestoresOperations)
     *
     ...
     * @throws Exception
     */
    public function listFeaturestoresOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(FeaturestoresOperations::class, 'Google_Service_Aiplatform_Resource_FeaturestoresOperations');
