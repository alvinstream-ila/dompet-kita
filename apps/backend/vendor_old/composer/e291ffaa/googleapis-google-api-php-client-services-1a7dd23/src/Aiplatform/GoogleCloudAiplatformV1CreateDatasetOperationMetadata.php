...
class GoogleCloudAiplatformV1CreateDatasetOperationMetadata extends Model
{
...
class_alias(GoogleCloudAiplatformV1CreateDatasetOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateDatasetOperationMetadata');
