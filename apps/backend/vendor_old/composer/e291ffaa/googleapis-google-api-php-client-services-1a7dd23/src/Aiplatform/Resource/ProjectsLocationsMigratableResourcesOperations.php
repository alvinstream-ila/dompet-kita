 ...
 *   $operations = $aiplatformService->projects_locations_migratableResources_operations;
 *  </code>
 */
class ProjectsLocationsMigratableResourcesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsMigratableResourcesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsMigratableResourcesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMigratableResourcesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMigratableResourcesOperations');
