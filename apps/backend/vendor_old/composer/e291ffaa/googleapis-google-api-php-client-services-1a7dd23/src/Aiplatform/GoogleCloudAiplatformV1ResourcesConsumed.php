...
class GoogleCloudAiplatformV1ResourcesConsumed extends Model
{
    /**
    ...
    {
        return $this->replicaHours;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ResourcesConsumed::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ResourcesConsumed');
