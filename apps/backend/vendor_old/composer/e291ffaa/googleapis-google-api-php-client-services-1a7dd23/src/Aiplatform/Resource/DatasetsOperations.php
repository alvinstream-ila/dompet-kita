 ...
 *   $operations = $aiplatformService->datasets_operations;
 *  </code>
 */
class DatasetsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDatasetsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDatasetsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DatasetsOperations::class, 'Google_Service_Aiplatform_Resource_DatasetsOperations');
