 ...
 *   $operations = $aiplatformService->metadataStores_operations;
 *  </code>
 */
class MetadataStoresOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listMetadataStoresOperations)
     *
     ...
     * @throws Exception
     */
    public function listMetadataStoresOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(MetadataStoresOperations::class, 'Google_Service_Aiplatform_Resource_MetadataStoresOperations');
