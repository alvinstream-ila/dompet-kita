 ...
 *   $operations = $aiplatformService->tensorboards_experiments_runs_operations;
 *  </code>
 */
class TensorboardsExperimentsRunsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listTensorboardsExperimentsRunsOperations)
     *
     ...
     * @throws Exception
     */
    public function listTensorboardsExperimentsRunsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(TensorboardsExperimentsRunsOperations::class, 'Google_Service_Aiplatform_Resource_TensorboardsExperimentsRunsOperations');
