...
class GoogleCloudAiplatformV1DeleteFeatureValuesRequestSelectEntity extends Model
{
    ...
    {
        return $this->entityIdSelector;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1DeleteFeatureValuesRequestSelectEntity::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1DeleteFeatureValuesRequestSelectEntity');
