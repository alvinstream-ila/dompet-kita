...
class GoogleCloudAiplatformV1FractionSplit extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1FractionSplit::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1FractionSplit');
