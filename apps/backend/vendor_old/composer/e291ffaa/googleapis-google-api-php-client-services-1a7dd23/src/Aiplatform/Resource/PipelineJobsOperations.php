 ...
 *   $operations = $aiplatformService->pipelineJobs_operations;
 *  </code>
 */
class PipelineJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listPipelineJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listPipelineJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(PipelineJobsOperations::class, 'Google_Service_Aiplatform_Resource_PipelineJobsOperations');
