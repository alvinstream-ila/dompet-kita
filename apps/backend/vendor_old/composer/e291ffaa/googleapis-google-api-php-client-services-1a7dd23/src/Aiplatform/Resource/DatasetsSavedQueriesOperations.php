 ...
 *   $operations = $aiplatformService->datasets_savedQueries_operations;
 *  </code>
 */
class DatasetsSavedQueriesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDatasetsSavedQueriesOperations)
     *
     ...
     * @throws Exception
     */
    public function listDatasetsSavedQueriesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DatasetsSavedQueriesOperations::class, 'Google_Service_Aiplatform_Resource_DatasetsSavedQueriesOperations');
