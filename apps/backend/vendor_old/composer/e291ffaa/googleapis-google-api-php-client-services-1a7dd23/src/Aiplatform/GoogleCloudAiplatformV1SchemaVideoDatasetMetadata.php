...
class GoogleCloudAiplatformV1SchemaVideoDatasetMetadata extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1SchemaVideoDatasetMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1SchemaVideoDatasetMetadata');
