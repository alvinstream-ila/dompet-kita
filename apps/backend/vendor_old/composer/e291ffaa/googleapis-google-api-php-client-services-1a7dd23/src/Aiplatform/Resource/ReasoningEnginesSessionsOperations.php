 ...
 *   $operations = $aiplatformService->reasoningEngines_sessions_operations;
 *  </code>
 */
class ReasoningEnginesSessionsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listReasoningEnginesSessionsOperations)
     *
     ...
     * @throws Exception
     */
    public function listReasoningEnginesSessionsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ReasoningEnginesSessionsOperations::class, 'Google_Service_Aiplatform_Resource_ReasoningEnginesSessionsOperations');
