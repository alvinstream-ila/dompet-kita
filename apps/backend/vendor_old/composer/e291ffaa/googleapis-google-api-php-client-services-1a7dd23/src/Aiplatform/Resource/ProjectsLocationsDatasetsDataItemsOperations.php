 ...
 *   $operations = $aiplatformService->projects_locations_datasets_dataItems_operations;
 *  </code>
 */
class ProjectsLocationsDatasetsDataItemsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDatasetsDataItemsOperations)
     *
...
class_alias(ProjectsLocationsDatasetsDataItemsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDatasetsDataItemsOperations');
