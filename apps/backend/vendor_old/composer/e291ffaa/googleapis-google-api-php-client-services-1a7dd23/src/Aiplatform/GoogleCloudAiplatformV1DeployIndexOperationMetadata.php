...
class GoogleCloudAiplatformV1DeployIndexOperationMetadata extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1DeployIndexOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1DeployIndexOperationMetadata');
