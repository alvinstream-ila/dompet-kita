...
class GoogleCloudAiplatformV1CreateFeatureOperationMetadata extends Model
{
...
class_alias(GoogleCloudAiplatformV1CreateFeatureOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateFeatureOperationMetadata');
