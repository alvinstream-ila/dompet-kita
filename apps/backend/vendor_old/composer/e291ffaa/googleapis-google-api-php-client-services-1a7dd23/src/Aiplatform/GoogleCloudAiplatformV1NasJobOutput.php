...
class GoogleCloudAiplatformV1NasJobOutput extends Model
{
    ...
    {
        $this->multiTrialJobOutput = $multiTrialJobOutput;
    }
    ...
    {
        return $this->multiTrialJobOutput;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1NasJobOutput::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1NasJobOutput');
