 ...
 *   $operations = $aiplatformService->modelDeploymentMonitoringJobs_operations;
 *  </code>
 */
class ModelDeploymentMonitoringJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listModelDeploymentMonitoringJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listModelDeploymentMonitoringJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ModelDeploymentMonitoringJobsOperations::class, 'Google_Service_Aiplatform_Resource_ModelDeploymentMonitoringJobsOperations');
