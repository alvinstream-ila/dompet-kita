...
class ProjectsLocationsEndpointsGoogleScience extends \Google\Service\Resource
{
    ...
    public function inference($endpoint, GoogleApiHttpBody $postBody, $optParams = [])
    {
        ...
        return $this->call('inference', [$params], GoogleApiHttpBody::class);
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsLocationsEndpointsGoogleScience::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsEndpointsGoogleScience');
