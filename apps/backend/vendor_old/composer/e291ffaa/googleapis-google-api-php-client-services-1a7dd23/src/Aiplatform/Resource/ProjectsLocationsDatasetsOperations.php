 ...
 *   $operations = $aiplatformService->projects_locations_datasets_operations;
 *  </code>
 */
class ProjectsLocationsDatasetsOperations extends \Google\Service\Resource
{
    /**
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDatasetsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDatasetsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDatasetsOperations');
