 ...
 *   $operations = $aiplatformService->datasets_dataItems_operations;
 *  </code>
 */
class DatasetsDataItemsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDatasetsDataItemsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDatasetsDataItemsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DatasetsDataItemsOperations::class, 'Google_Service_Aiplatform_Resource_DatasetsDataItemsOperations');
