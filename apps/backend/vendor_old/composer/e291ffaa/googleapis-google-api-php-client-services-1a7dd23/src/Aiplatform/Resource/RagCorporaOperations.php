 ...
 *   $operations = $aiplatformService->ragCorpora_operations;
 *  </code>
 */
class RagCorporaOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listRagCorporaOperations)
     *
     ...
     * @throws Exception
     */
    public function listRagCorporaOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(RagCorporaOperations::class, 'Google_Service_Aiplatform_Resource_RagCorporaOperations');
