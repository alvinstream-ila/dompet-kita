 ...
 *   $operations = $aiplatformService->models_operations;
 *  </code>
 */
class ModelsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listModelsOperations)
     *
     ...
     * @throws Exception
     */
    public function listModelsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ModelsOperations::class, 'Google_Service_Aiplatform_Resource_ModelsOperations');
