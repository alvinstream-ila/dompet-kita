...
class GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfig extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfig::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfig');
