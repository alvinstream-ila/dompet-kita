 ...
 *   $operations = $aiplatformService->datasets_annotationSpecs_operations;
 *  </code>
 */
class DatasetsAnnotationSpecsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listDatasetsAnnotationSpecsOperations)
     *
     ...
     * @throws Exception
     */
    public function listDatasetsAnnotationSpecsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(DatasetsAnnotationSpecsOperations::class, 'Google_Service_Aiplatform_Resource_DatasetsAnnotationSpecsOperations');
