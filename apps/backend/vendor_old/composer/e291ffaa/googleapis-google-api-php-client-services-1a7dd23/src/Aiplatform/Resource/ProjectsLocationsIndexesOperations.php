 ...
 *   $operations = $aiplatformService->projects_locations_indexes_operations;
 *  </code>
 */
class ProjectsLocationsIndexesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsIndexesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsIndexesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsIndexesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsIndexesOperations');
