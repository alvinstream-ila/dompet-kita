 ...
 *   $operations = $aiplatformService->projects_locations_metadataStores_artifacts_operations;
 *  </code>
 */
class ProjectsLocationsMetadataStoresArtifactsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsMetadataStoresArtifactsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsMetadataStoresArtifactsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMetadataStoresArtifactsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMetadataStoresArtifactsOperations');
