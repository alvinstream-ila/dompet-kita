 ...
 *   $operations = $aiplatformService->projects_locations_models_operations;
 *  </code>
 */
class ProjectsLocationsModelsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsModelsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsModelsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsModelsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsModelsOperations');
