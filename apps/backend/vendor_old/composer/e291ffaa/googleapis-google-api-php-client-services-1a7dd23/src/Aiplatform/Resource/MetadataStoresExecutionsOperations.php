 ...
 *   $operations = $aiplatformService->metadataStores_executions_operations;
 *  </code>
 */
class MetadataStoresExecutionsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listMetadataStoresExecutionsOperations)
     *
     ...
     * @throws Exception
     */
    public function listMetadataStoresExecutionsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(MetadataStoresExecutionsOperations::class, 'Google_Service_Aiplatform_Resource_MetadataStoresExecutionsOperations');
