...
class GoogleCloudAiplatformV1PurgeExecutionsRequest extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1PurgeExecutionsRequest::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1PurgeExecutionsRequest');
