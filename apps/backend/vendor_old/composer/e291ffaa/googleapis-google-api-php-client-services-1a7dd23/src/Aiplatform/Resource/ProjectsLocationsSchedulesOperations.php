 ...
 *   $operations = $aiplatformService->projects_locations_schedules_operations;
 *  </code>
 */
class ProjectsLocationsSchedulesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsSchedulesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsSchedulesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsSchedulesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsSchedulesOperations');
