 ...
 *   $operations = $aiplatformService->projects_locations_datasets_dataItems_annotations_operations;
 *  </code>
 */
class ProjectsLocationsDatasetsDataItemsAnnotationsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDatasetsDataItemsAnnotationsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDatasetsDataItemsAnnotationsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDatasetsDataItemsAnnotationsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDatasetsDataItemsAnnotationsOperations');
