 ...
 *   $operations = $aiplatformService->projects_locations_datasets_annotationSpecs_operations;
 *  </code>
 */
class ProjectsLocationsDatasetsAnnotationSpecsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDatasetsAnnotationSpecsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDatasetsAnnotationSpecsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDatasetsAnnotationSpecsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDatasetsAnnotationSpecsOperations');
