 ...
 *   $operations = $aiplatformService->projects_locations_ragEngineConfig_operations;
 *  </code>
 */
class ProjectsLocationsRagEngineConfigOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsRagEngineConfigOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsRagEngineConfigOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsRagEngineConfigOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsRagEngineConfigOperations');
