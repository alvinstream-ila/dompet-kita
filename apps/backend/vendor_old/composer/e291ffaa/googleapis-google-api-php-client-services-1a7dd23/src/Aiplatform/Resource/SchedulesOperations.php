 ...
 *   $operations = $aiplatformService->schedules_operations;
 *  </code>
 */
class SchedulesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listSchedulesOperations)
     *
     ...
     * @throws Exception
     */
    public function listSchedulesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(SchedulesOperations::class, 'Google_Service_Aiplatform_Resource_SchedulesOperations');
