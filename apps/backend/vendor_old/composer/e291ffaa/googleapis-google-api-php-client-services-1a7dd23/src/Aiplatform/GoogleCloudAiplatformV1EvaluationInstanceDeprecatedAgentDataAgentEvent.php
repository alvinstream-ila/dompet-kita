...
class GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentDataAgentEvent extends Collection
{
...
class_alias(GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentDataAgentEvent::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentDataAgentEvent');
