 ...
 *   $operations = $aiplatformService->projects_locations_notebookRuntimeTemplates_operations;
 *  </code>
 */
class ProjectsLocationsNotebookRuntimeTemplatesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsNotebookRuntimeTemplatesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsNotebookRuntimeTemplatesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsNotebookRuntimeTemplatesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsNotebookRuntimeTemplatesOperations');
