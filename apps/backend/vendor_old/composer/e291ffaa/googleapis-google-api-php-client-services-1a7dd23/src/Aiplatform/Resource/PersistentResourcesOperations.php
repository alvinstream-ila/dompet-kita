 ...
 *   $operations = $aiplatformService->persistentResources_operations;
 *  </code>
 */
class PersistentResourcesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listPersistentResourcesOperations)
     *
     ...
     * @throws Exception
     */
    public function listPersistentResourcesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(PersistentResourcesOperations::class, 'Google_Service_Aiplatform_Resource_PersistentResourcesOperations');
