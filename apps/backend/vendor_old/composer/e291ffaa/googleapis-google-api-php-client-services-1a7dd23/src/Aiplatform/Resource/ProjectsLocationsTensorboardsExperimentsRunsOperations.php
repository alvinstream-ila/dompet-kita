 ...
 *   $operations = $aiplatformService->projects_locations_tensorboards_experiments_runs_operations;
 *  </code>
 */
class ProjectsLocationsTensorboardsExperimentsRunsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsTensorboardsExperimentsRunsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsTensorboardsExperimentsRunsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTensorboardsExperimentsRunsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTensorboardsExperimentsRunsOperations');
