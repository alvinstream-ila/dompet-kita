...
class GoogleCloudAiplatformV1CreateTensorboardOperationMetadata extends Model
{
...
class_alias(GoogleCloudAiplatformV1CreateTensorboardOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateTensorboardOperationMetadata');
