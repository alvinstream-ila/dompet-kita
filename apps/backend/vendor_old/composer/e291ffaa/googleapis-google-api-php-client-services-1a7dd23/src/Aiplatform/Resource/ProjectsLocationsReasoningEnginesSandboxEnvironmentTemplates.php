 ...
 *   $sandboxEnvironmentTemplates = $aiplatformService->projects_locations_reasoningEngines_sandboxEnvironmentTemplates;
 *  </code>
 */
class ProjectsLocationsReasoningEnginesSandboxEnvironmentTemplates extends \Google\Service\Resource
{
    /**
    ...
    /**
     * Lists SandboxEnvironmentTemplates in a given reasoning engine. (sandboxEnviro
     * nmentTemplates.listProjectsLocationsReasoningEnginesSandboxEnvironmentTemplat
     * es)
     *
     * @param  string  $parent  Required. The resource name of the reasoning engine to
     ...
     * @throws Exception
     */
    public function listProjectsLocationsReasoningEnginesSandboxEnvironmentTemplates($parent, $optParams = [])
    {
...
class_alias(ProjectsLocationsReasoningEnginesSandboxEnvironmentTemplates::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsReasoningEnginesSandboxEnvironmentTemplates');
