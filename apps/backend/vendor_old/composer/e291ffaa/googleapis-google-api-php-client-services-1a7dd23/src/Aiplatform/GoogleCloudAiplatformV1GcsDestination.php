...
class GoogleCloudAiplatformV1GcsDestination extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1GcsDestination::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1GcsDestination');
