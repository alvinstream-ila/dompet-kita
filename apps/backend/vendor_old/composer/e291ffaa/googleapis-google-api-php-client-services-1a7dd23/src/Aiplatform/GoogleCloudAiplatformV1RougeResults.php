...
class GoogleCloudAiplatformV1RougeResults extends Collection
{
    ...
    {
        return $this->rougeMetricValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1RougeResults::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1RougeResults');
