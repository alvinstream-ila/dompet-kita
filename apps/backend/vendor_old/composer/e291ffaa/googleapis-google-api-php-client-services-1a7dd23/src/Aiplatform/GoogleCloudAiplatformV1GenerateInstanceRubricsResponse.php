...
class GoogleCloudAiplatformV1GenerateInstanceRubricsResponse extends Collection
{
    ...
    {
        $this->generatedRubrics = $generatedRubrics;
    }
    ...
    {
        return $this->generatedRubrics;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1GenerateInstanceRubricsResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1GenerateInstanceRubricsResponse');
