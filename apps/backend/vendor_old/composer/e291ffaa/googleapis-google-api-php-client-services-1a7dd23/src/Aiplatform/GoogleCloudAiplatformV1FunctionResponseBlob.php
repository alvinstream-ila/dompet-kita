...
class GoogleCloudAiplatformV1FunctionResponseBlob extends Model
{
    /**
     * Required. Raw bytes.
     *
...
class_alias(GoogleCloudAiplatformV1FunctionResponseBlob::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1FunctionResponseBlob');
