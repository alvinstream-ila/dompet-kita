 ...
 *   $operations = $aiplatformService->trainingPipelines_operations;
 *  </code>
 */
class TrainingPipelinesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listTrainingPipelinesOperations)
     *
     ...
     * @throws Exception
     */
    public function listTrainingPipelinesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(TrainingPipelinesOperations::class, 'Google_Service_Aiplatform_Resource_TrainingPipelinesOperations');
