 ...
 *   $operations = $aiplatformService->projects_locations_modelDeploymentMonitoringJobs_operations;
 *  </code>
 */
class ProjectsLocationsModelDeploymentMonitoringJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsModelDeploymentMonitoringJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsModelDeploymentMonitoringJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsModelDeploymentMonitoringJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsModelDeploymentMonitoringJobsOperations');
