 ...
 *   $operations = $aiplatformService->indexEndpoints_operations;
 *  </code>
 */
class IndexEndpointsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listIndexEndpointsOperations)
     *
     ...
     * @throws Exception
     */
    public function listIndexEndpointsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(IndexEndpointsOperations::class, 'Google_Service_Aiplatform_Resource_IndexEndpointsOperations');
