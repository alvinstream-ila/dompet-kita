 ...
 *   $operations = $aiplatformService->projects_locations_pipelineJobs_operations;
 *  </code>
 */
class ProjectsLocationsPipelineJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsPipelineJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsPipelineJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsPipelineJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsPipelineJobsOperations');
