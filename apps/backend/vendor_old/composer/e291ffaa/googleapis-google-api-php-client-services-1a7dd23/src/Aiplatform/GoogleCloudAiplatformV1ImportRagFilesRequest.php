...
class GoogleCloudAiplatformV1ImportRagFilesRequest extends Model
{
    ...
    {
        return $this->importRagFilesConfig;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ImportRagFilesRequest::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ImportRagFilesRequest');
