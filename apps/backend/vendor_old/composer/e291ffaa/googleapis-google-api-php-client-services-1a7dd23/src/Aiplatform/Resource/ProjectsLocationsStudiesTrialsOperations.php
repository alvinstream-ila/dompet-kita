 ...
 *   $operations = $aiplatformService->projects_locations_studies_trials_operations;
 *  </code>
 */
class ProjectsLocationsStudiesTrialsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsStudiesTrialsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsStudiesTrialsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsStudiesTrialsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsStudiesTrialsOperations');
