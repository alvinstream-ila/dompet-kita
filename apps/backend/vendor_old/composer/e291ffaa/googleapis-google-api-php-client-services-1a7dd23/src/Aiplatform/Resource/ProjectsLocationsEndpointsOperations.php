 ...
 *   $operations = $aiplatformService->projects_locations_endpoints_operations;
 *  </code>
 */
class ProjectsLocationsEndpointsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsEndpointsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsEndpointsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsEndpointsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsEndpointsOperations');
