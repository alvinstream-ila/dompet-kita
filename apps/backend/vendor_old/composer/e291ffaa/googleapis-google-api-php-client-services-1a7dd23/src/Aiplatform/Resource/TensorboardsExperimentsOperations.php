 ...
 *   $operations = $aiplatformService->tensorboards_experiments_operations;
 *  </code>
 */
class TensorboardsExperimentsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listTensorboardsExperimentsOperations)
     *
     ...
     * @throws Exception
     */
    public function listTensorboardsExperimentsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(TensorboardsExperimentsOperations::class, 'Google_Service_Aiplatform_Resource_TensorboardsExperimentsOperations');
