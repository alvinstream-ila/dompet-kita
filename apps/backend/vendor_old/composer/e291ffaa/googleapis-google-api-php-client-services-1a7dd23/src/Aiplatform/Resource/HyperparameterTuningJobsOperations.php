 ...
 *   $operations = $aiplatformService->hyperparameterTuningJobs_operations;
 *  </code>
 */
class HyperparameterTuningJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listHyperparameterTuningJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listHyperparameterTuningJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(HyperparameterTuningJobsOperations::class, 'Google_Service_Aiplatform_Resource_HyperparameterTuningJobsOperations');
