...
class GoogleCloudAiplatformV1DistillationDataStats extends Model
{
    ...
    {
        return $this->trainingDatasetStats;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1DistillationDataStats::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1DistillationDataStats');
