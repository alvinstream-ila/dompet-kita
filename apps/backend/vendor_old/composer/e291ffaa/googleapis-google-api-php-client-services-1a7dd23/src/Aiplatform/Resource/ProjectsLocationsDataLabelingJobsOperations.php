 ...
 *   $operations = $aiplatformService->projects_locations_dataLabelingJobs_operations;
 *  </code>
 */
class ProjectsLocationsDataLabelingJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsDataLabelingJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsDataLabelingJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDataLabelingJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsDataLabelingJobsOperations');
