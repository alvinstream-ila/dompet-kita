 ...
 *   $operations = $aiplatformService->projects_locations_reasoningEngines_sessions_operations;
 *  </code>
 */
class ProjectsLocationsReasoningEnginesSessionsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsReasoningEnginesSessionsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsReasoningEnginesSessionsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsReasoningEnginesSessionsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsReasoningEnginesSessionsOperations');
