 ...
 *   $operations = $aiplatformService->endpoints_operations;
 *  </code>
 */
class EndpointsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listEndpointsOperations)
     *
     ...
     * @throws Exception
     */
    public function listEndpointsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(EndpointsOperations::class, 'Google_Service_Aiplatform_Resource_EndpointsOperations');
