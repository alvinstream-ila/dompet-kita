...
class GoogleCloudAiplatformV1DeployRequestDeployConfig extends Model
{
...
class_alias(GoogleCloudAiplatformV1DeployRequestDeployConfig::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1DeployRequestDeployConfig');
