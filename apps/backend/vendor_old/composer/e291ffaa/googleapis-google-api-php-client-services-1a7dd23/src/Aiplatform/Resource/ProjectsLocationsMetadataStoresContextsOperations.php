 ...
 *   $operations = $aiplatformService->projects_locations_metadataStores_contexts_operations;
 *  </code>
 */
class ProjectsLocationsMetadataStoresContextsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsMetadataStoresContextsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsMetadataStoresContextsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMetadataStoresContextsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMetadataStoresContextsOperations');
