 ...
 *   $operations = $aiplatformService->projects_locations_persistentResources_operations;
 *  </code>
 */
class ProjectsLocationsPersistentResourcesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsPersistentResourcesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsPersistentResourcesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsPersistentResourcesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsPersistentResourcesOperations');
