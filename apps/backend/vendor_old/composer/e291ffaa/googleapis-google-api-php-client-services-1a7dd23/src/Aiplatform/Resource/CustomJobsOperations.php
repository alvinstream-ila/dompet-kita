 ...
 *   $operations = $aiplatformService->customJobs_operations;
 *  </code>
 */
class CustomJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listCustomJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listCustomJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(CustomJobsOperations::class, 'Google_Service_Aiplatform_Resource_CustomJobsOperations');
