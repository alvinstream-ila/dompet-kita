...
class GoogleCloudAiplatformV1DeployIndexResponse extends Model
{
...
class_alias(GoogleCloudAiplatformV1DeployIndexResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1DeployIndexResponse');
