 ...
 *   $operations = $aiplatformService->projects_locations_featurestores_entityTypes_operations;
 *  </code>
 */
class ProjectsLocationsFeaturestoresEntityTypesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsFeaturestoresEntityTypesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsFeaturestoresEntityTypesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsFeaturestoresEntityTypesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsFeaturestoresEntityTypesOperations');
