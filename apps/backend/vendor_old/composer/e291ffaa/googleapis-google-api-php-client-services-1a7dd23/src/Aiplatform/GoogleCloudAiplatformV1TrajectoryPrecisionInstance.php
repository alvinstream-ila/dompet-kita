...
class GoogleCloudAiplatformV1TrajectoryPrecisionInstance extends Model
{
...
class_alias(GoogleCloudAiplatformV1TrajectoryPrecisionInstance::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectoryPrecisionInstance');
