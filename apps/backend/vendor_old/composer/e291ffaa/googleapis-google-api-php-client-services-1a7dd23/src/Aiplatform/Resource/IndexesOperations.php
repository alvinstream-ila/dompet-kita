 ...
 *   $operations = $aiplatformService->indexes_operations;
 *  </code>
 */
class IndexesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listIndexesOperations)
     *
     ...
     * @throws Exception
     */
    public function listIndexesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(IndexesOperations::class, 'Google_Service_Aiplatform_Resource_IndexesOperations');
