...
class GoogleCloudAiplatformV1FilterSplit extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1FilterSplit::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1FilterSplit');
