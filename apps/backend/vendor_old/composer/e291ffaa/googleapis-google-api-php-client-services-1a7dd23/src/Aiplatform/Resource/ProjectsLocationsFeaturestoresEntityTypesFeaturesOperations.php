 ...
 *   $operations = $aiplatformService->projects_locations_featurestores_entityTypes_features_operations;
 *  </code>
 */
class ProjectsLocationsFeaturestoresEntityTypesFeaturesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsFeaturestoresEntityTypesFeaturesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsFeaturestoresEntityTypesFeaturesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsFeaturestoresEntityTypesFeaturesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsFeaturestoresEntityTypesFeaturesOperations');
