 ...
 *   $operations = $aiplatformService->reasoningEngines_operations;
 *  </code>
 */
class ReasoningEnginesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listReasoningEnginesOperations)
     *
     ...
     * @throws Exception
     */
    public function listReasoningEnginesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ReasoningEnginesOperations::class, 'Google_Service_Aiplatform_Resource_ReasoningEnginesOperations');
