 ...
 *   $operations = $aiplatformService->projects_locations_studies_operations;
 *  </code>
 */
class ProjectsLocationsStudiesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsStudiesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsStudiesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsStudiesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsStudiesOperations');
