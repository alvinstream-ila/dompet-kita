 ...
 *   $operations = $aiplatformService->models_evaluations_operations;
 *  </code>
 */
class ModelsEvaluationsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listModelsEvaluationsOperations)
     *
     ...
     * @throws Exception
     */
    public function listModelsEvaluationsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ModelsEvaluationsOperations::class, 'Google_Service_Aiplatform_Resource_ModelsEvaluationsOperations');
