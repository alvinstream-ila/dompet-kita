 ...
 *   $operations = $aiplatformService->ragCorpora_ragFiles_operations;
 *  </code>
 */
class RagCorporaRagFilesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listRagCorporaRagFilesOperations)
     *
     ...
     * @throws Exception
     */
    public function listRagCorporaRagFilesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(RagCorporaRagFilesOperations::class, 'Google_Service_Aiplatform_Resource_RagCorporaRagFilesOperations');
