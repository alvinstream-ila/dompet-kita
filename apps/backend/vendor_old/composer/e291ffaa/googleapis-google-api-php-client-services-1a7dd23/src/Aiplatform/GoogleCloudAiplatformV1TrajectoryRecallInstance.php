...
class GoogleCloudAiplatformV1TrajectoryRecallInstance extends Model
{
...
class_alias(GoogleCloudAiplatformV1TrajectoryRecallInstance::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TrajectoryRecallInstance');
