...
class GoogleCloudAiplatformV1TensorboardBlob extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1TensorboardBlob::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1TensorboardBlob');
