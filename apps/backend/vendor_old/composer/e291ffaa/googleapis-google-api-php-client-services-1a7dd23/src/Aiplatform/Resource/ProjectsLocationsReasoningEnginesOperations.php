 ...
 *   $operations = $aiplatformService->projects_locations_reasoningEngines_operations;
 *  </code>
 */
class ProjectsLocationsReasoningEnginesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsReasoningEnginesOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsReasoningEnginesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsReasoningEnginesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsReasoningEnginesOperations');
