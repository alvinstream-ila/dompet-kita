 ...
 *   $operations = $aiplatformService->ragEngineConfig_operations;
 *  </code>
 */
class RagEngineConfigOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listRagEngineConfigOperations)
     *
     ...
     * @throws Exception
     */
    public function listRagEngineConfigOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(RagEngineConfigOperations::class, 'Google_Service_Aiplatform_Resource_RagEngineConfigOperations');
