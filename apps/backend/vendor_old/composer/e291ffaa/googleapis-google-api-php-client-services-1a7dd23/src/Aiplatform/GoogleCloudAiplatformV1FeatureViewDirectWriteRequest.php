...
class GoogleCloudAiplatformV1FeatureViewDirectWriteRequest extends Collection
{
    ...
    {
        return $this->dataKeyAndFeatureValues;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1FeatureViewDirectWriteRequest::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1FeatureViewDirectWriteRequest');
