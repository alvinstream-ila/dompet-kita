...
class GoogleCloudAiplatformV1JiraSource extends Collection
{
    ...
    {
        return $this->jiraQueries;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1JiraSource::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1JiraSource');
