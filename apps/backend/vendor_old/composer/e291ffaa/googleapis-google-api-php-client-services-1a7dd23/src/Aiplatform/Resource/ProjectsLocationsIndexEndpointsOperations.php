 ...
 *   $operations = $aiplatformService->projects_locations_indexEndpoints_operations;
 *  </code>
 */
class ProjectsLocationsIndexEndpointsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsIndexEndpointsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsIndexEndpointsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsIndexEndpointsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsIndexEndpointsOperations');
