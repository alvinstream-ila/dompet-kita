 ...
 *   $runtimeRevisions = $aiplatformService->reasoningEngines_runtimeRevisions;
 *  </code>
 */
class ReasoningEnginesRuntimeRevisions extends \Google\Service\Resource
{
    /**
...
class_alias(ReasoningEnginesRuntimeRevisions::class, 'Google_Service_Aiplatform_Resource_ReasoningEnginesRuntimeRevisions');
