...
class GoogleCloudAiplatformV1ListNotebookRuntimeTemplatesResponse extends Collection
{
    ...
    {
        return $this->notebookRuntimeTemplates;
    }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAiplatformV1ListNotebookRuntimeTemplatesResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ListNotebookRuntimeTemplatesResponse');
