 ...
 *   $operations = $aiplatformService->projects_locations_customJobs_operations;
 *  </code>
 */
class ProjectsLocationsCustomJobsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsCustomJobsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsCustomJobsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsCustomJobsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsCustomJobsOperations');
