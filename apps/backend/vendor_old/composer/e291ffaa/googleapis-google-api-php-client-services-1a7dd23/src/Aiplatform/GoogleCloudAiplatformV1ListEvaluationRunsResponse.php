...
class GoogleCloudAiplatformV1ListEvaluationRunsResponse extends Collection
{
    protected $collection_key = 'evaluationRuns';
...
class_alias(GoogleCloudAiplatformV1ListEvaluationRunsResponse::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ListEvaluationRunsResponse');
