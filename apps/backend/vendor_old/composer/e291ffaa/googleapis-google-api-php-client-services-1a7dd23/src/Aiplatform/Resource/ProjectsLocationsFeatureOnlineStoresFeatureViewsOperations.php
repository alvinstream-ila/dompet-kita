 ...
 *   $operations = $aiplatformService->projects_locations_featureOnlineStores_featureViews_operations;
 *  </code>
 */
class ProjectsLocationsFeatureOnlineStoresFeatureViewsOperations extends \Google\Service\Resource
{
    /**
    ...
    public function listWait($name, $optParams = [])
    {
        ...
        return $this->call('listWait', [$params], GoogleLongrunningListOperationsResponse::class);
    }
...
class_alias(ProjectsLocationsFeatureOnlineStoresFeatureViewsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsFeatureOnlineStoresFeatureViewsOperations');
