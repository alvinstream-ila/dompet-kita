 ...
 *   $operations = $aiplatformService->projects_locations_tensorboards_operations;
 *  </code>
 */
class ProjectsLocationsTensorboardsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listProjectsLocationsTensorboardsOperations)
     *
     ...
     * @throws Exception
     */
    public function listProjectsLocationsTensorboardsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTensorboardsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTensorboardsOperations');
