...
class GoogleCloudAiplatformV1PurgeArtifactsRequest extends Model
{
    /**
...
class_alias(GoogleCloudAiplatformV1PurgeArtifactsRequest::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1PurgeArtifactsRequest');
