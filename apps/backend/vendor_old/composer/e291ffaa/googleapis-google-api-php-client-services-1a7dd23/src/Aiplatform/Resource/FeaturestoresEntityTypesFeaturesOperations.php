 ...
 *   $operations = $aiplatformService->featurestores_entityTypes_features_operations;
 *  </code>
 */
class FeaturestoresEntityTypesFeaturesOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listFeaturestoresEntityTypesFeaturesOperations)
     *
     ...
     * @throws Exception
     */
    public function listFeaturestoresEntityTypesFeaturesOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(FeaturestoresEntityTypesFeaturesOperations::class, 'Google_Service_Aiplatform_Resource_FeaturestoresEntityTypesFeaturesOperations');
