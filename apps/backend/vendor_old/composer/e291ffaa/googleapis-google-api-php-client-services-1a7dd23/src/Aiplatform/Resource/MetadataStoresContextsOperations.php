 ...
 *   $operations = $aiplatformService->metadataStores_contexts_operations;
 *  </code>
 */
class MetadataStoresContextsOperations extends \Google\Service\Resource
{
    /**
     ...
     * (operations.listMetadataStoresContextsOperations)
     *
     ...
     * @throws Exception
     */
    public function listMetadataStoresContextsOperations($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = array_merge($params, $optParams);
...
class_alias(MetadataStoresContextsOperations::class, 'Google_Service_Aiplatform_Resource_MetadataStoresContextsOperations');
